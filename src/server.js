...
app.get('/api/knowledge',requireAdmin,async(req,res)=>{const r=await brainPool.query(`SELECT * FROM knowledge_base ORDER BY id DESC`);res.json({ok:true,items:r.rows});});
